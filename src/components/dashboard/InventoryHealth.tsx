      ...
      <div className="glass-card rounded-xl p-6">
        ...
        <ResponsiveContainer width="100%" height={240}>
          ...
          >
            ...
            <YAxis
              type="category"
              dataKey="name"
              tick={{ fill: "hsl(45,20%,80%)", fontSize: 12 }}
              axisLine={false}
              tickLine={false}
              width={100}
            />
            <Tooltip content={<CustomTooltip />} cursor={{ fill: "hsl(240,10%,11%)" }} />
        ...
        <div className="flex items-center gap-6 mt-4 text-xs text-muted-foreground">
          <span className="flex items-center gap-1.5">
            <span className="w-3 h-0.5 bg-warning inline-block" style={{ borderTop: "2px dashed hsl(38,92%,50%)" }} />
            &lt; 8 sem: Riesgo
          </span>
          <span className="flex items-center gap-1.5">
            <span className="w-3 h-0.5 bg-danger inline-block" style={{ borderTop: "2px dashed hsl(0,72%,51%)" }} />
            &gt; 20 sem: Sobrestock
          </span>
        </div>
      </div>
