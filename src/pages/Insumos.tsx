        ...
        <main className="flex-1 min-w-0 flex flex-col">
          <header className="flex items-center justify-between px-6 py-4 border-b border-border sticky top-0 bg-background/90 backdrop-blur-sm z-10">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-display text-lg font-semibold text-foreground">Gestión de Insumos</h2>
                <p className="text-xs text-muted-foreground">CEDI Guayabal · Bolsas & Insumos</p>
              </div>
            </div>
          </header>
