    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/configuracion/usuarios" element={<ProtectedRoute><ConfiguracionUsuariosPage /></ProtectedRoute>} />
          <Route path="/configuracion/roles" element={<ProtectedRoute><ConfiguracionRolesPage /></ProtectedRoute>} />
