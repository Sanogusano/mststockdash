    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/validacion-clasificacion" element={<Guard module="dashboards.inventario_salud" action="view"><ValidacionClasificacionPage /></Guard>} />
          ...
          <Route path="/clasificacion-producto" element={<Guard module="dashboards.salud_producto" action="view"><ClasificacionProductoPage /></Guard>} />న
