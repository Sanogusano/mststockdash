...
BEGIN
    ...
    -- Limpiar liquidaciones previas para recalcular
    ...
    ELSIF v_regla.tipo_regla = 'venta_sku' THEN
        ...
        IF v_inc.alcance = 'asesor' THEN
            ...
            SELECT
                ...
                MAX(o.location_id),
                jsonb_build_object(
                    'unidades_vendidas', SUM(oi.quantity),
                    'meta', v_regla.valor_objetivo,
    ...
    ELSIF v_regla.tipo_regla IN ('ticket_minimo', 'upt_minimo', 'numero_pedidos') THEN
        ...
        SELECT
            ...
            MAX(o.location_id),
            jsonb_build_object(
                'transacciones', COUNT(DISTINCT o.shopify_order_id),
                'meta', v_regla.valor_objetivo,
