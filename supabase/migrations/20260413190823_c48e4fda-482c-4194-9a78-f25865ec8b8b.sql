...
-- Critical missing index for inventory JOINs
CREATE INDEX IF NOT EXISTS idx_catalog_variant_id ON public.product_catalog (variant_id);

-- Index for category filtering
CREATE INDEX IF NOT EXISTS idx_catalog_category ON public.product_catalog (category);

-- Rebuild function with extended timeout
...
-- Also update _latest_valid_snapshot_date with extended timeout
